...
hir = plot(hi, "ribbon", color = color.new(hicolor, 98))
lor = plot(lo, "ribbon",color = color.new(locolor, 98))

plot(cl, "ribbon",color = color.new(clcolor, 98))
plot(op, "ribbon",color = color.new(opcolor, 98))
